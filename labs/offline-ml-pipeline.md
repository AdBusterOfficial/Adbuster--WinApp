...
The entire workflow — recording, feature extraction, CSV generation, model training and deployment — runs fully offline inside AdusterML, producing a stable `ad_detector.pkl` ready for further research and prototyping.
