...
where **AVG** is the smoothed average of the last ~20 minutes of audio input.
...
- After 5 minutes → ML threshold updates to the new **AVG − 2**  
...
This is the most intelligent and adaptive version of CEPA Logic to date.
