...
- 🎚️ The system performs initial **calibration**, which sets the baseline threshold.  
- 🖱️ The user may override this value using the GUI slider.  
...
- 🖱️ the GUI slider provides manual override,  
- ⏱️ CEPA enters manual mode for a short period (e.g., 3 seconds),  
...
2. 🎚️ Manual override via slider  
...
- 🕹️ CEPA switches to manual mode,  
- 🎚️ the threshold is set directly to the slider value,  
...
- ⚙️ The current NR 5 implementation uses a calibrated threshold:  
  - 📌 baseline from calibration,  
  - 🖱️ optional manual override via slider,  
